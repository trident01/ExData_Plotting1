...
plot(t, as.numeric(as.character(sData$Voltage)), type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(t, as.numeric(as.character(sData$Global_reactive_power)), type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
